...
import com.example.projectdemo.model.UserBankDetails;
...
public class StockTradeDAO {
	...
	@Transactional
	public Trade createBuyTrade(org.apache.catalina.User user, Stock s, String quantity, Transaction transaction) {
